 # Serverless REST API [![Build Status](https://travis-ci.org/melvinlee/lambda-restapi-nodejs.svg?branch=master)](https://travis-ci.org/melvinlee/lambda-restapi-nodejs)
